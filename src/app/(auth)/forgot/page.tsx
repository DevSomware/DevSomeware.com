...
function SignupFormDemo() {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    const fetchdata = await fetch("/api/forgot", {
      method: "POST",
      headers: {
    ...
    setLoading(false);
    if (data.success) {
      toast.success("Email has been sent to your email address for password reset. Please check your email.");
...
<p className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300">
  No worries! Enter your email to reset your password and get back on track. 🛠️
</p>
