    ...
    <div className="max-w-md  mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-gray-900 my-12">
      ...
      <div className="my-8" >
        ...
        <LabelInputContainer className="mb-4">
          ...
          <Input id="email" placeholder="team@devsomeware.com" type="email" onChange={(e)=>{
        ...
        <div className="flex flex-col space-y-4">
          <button
            ...
            onClick={()=>{
                toast.info("Github login is not available yet. Please try another method.")
            }}
          >
          ...
          <button
            className=" relative group/btn flex space-x-2 items-center justify-start px-4 w-full text-black rounded-md h-10 font-medium shadow-input bg-gray-50 dark:bg-zinc-900 dark:shadow-[0px_0px_1px_1px_var(--neutral-800)]"
            onClick={()=>{
                toast.info("Google login is not available yet. Please try another method.")
            }}
          >
