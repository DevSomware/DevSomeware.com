...
export const Button = (props: React.PropsWithChildren) => {
  return (
    <button className="relative py-2 px-6 text-white text-xl font-medium rounded-full bg-gradient-to-b from-[#190d2e] to-[#4a208a] shadow-[0px_0px_12px_#8c45ff] hover:shadow-[0px_0px_20px_#8c45ff] transition-all duration-300 ease-in-out overflow-hidden">
